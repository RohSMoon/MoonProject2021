...
/////////////추가패널 부분
//		confing_BaseJPanel = new JPanel();
//		confing_BaseJPanel.setBackground(Color.WHITE); 
//		confing_BaseJPanel.setBounds(0, 0, 272, 430);  
//		confing_BaseJPanel.setLayout(null);       
		...
		userInfo_jbtn.addActionListener(new Config_Panel_Ctrl(this)); //  사용자 정보 버튼 액션
		...
		changeStatus_jbtn.addActionListener(new Config_Panel_Ctrl(this)); // 상태버튼 액션
		...
		LogOut_jbtn.addActionListener(new Config_Panel_Ctrl(this)); // 로그아웃 버튼 액션
