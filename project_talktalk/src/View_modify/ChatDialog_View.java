...
public class ChatDialog_View extends JDialog {
	...
	JTextArea showChat_jta			  ; // 채팅출력창
	JTextArea showWhochatJoined_jta	  ;//참가자 목록창
	...
	private void initialize() { // 화면출력 메소드
		...
		send_jbtn.addActionListener(new ChatDialog_Ctrl(this));// 전송버튼 액션
		...
		this.setTitle("대화방 제목"); // 다이얼로그 타이틀 
