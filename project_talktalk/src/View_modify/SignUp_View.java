...
public class SignUp_View extends JDialog {
	...
	JTextField 		signUpView_Pw_jtf                        ; // 패스워드 입력창
...
//	} //////////End of Launch the application.//////////End of Launch the application.//////////End of Launch the application.//////////End of Launch the application.
	...
	private void initialize() { // 화면 출력 메소드
		...
		this.add(SignUp_View_jpl	, BorderLayout.CENTER); // 프레임에 베이스 패널 추가
		...
		signUpView_Pw_jtf = new JTextField(); // 비밀번호 입력창 생성 
...
////////////////////////////////////////////////////////////////////////
		...
		signUpView_Submit_jbtn.addActionListener(new SignUp_Ctrl(this)); // 제출버튼 액션 리스너 생성 
		...
		signUpView_Cancel_jbtn.addActionListener(new SignUp_Ctrl(this)); // 취소버튼 액션리스너 추가
/////////////////////		////////////////////////////////////////////////////////
