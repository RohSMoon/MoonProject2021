...
public class SignUp_Ctrl implements ActionListener {
	SignUp_View signUp_View;  // 회원가입창 선언
	
	public SignUp_Ctrl(SignUp_View signUp_View) {
		this.signUp_View = signUp_View; // 회원가입창 주소번지 동기화
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (signUp_View.signUpView_Submit_jbtn == obj) {  // 제출버튼 누를시
	///***********************************************//// 회원가입 입력부		
...
//			이 뒤로는 제출버튼 눌리고 서버 -> DB 실행문
		...
		if (signUp_View.signUpView_Cancel_jbtn == obj) { // 취소버튼 누르면
			signUp_View.dispose(); //  꺼진다.
		}
