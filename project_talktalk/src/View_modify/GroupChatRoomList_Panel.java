...
public class GroupChatRoomList_Panel extends JPanel {         
	...
	String 				cols[]		= {"번호","제목","인원"} 	 ; // 컬럼에 헤더 값
	String 		    	data[][] 	= new String[0][3]		 ; // 초기 데이터 크기 지정
	...
	DefaultTableModel 	group_dtm                            ; // 그룹채팅 테이블  데이타셋
...
//		this = new JPanel();
		...
		group_dtm = new DefaultTableModel(data,cols); //  데이터셋에 컬럼 크기와데이터 정보 주입
